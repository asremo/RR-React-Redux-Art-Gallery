//  The primary reason for this particular 
// instance of state will be to store API data.
...
const initialState = {
    objectId: 10245, // to drive API results
    apiData: {} // to store the actual data from the API
}
